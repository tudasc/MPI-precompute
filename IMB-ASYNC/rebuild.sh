...
make clean
OMPI_CXX=clang++ CXX=mpicxx CXXFLAGS="-Xclang -load -Xclang /home/td37cari/ucx-testing/build/mpi_compiler_assistance_matching_pass/libmpi_compiler_assistance_matching_pass.so" make
