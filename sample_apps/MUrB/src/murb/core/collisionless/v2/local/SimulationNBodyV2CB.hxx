 ...
 * \brief   Implementation of SimulationNBodyLocal with the Cache Blocking
 * Technique (n²/2 computations). \author  A. Cassagne \date    2014
 *
 * \section LICENSE
...
template <typename T> SimulationNBodyV2CB<T>::~SimulationNBodyV2CB() {}
...
#pragma omp for schedule(runtime)
      for (unsigned long iBody = jOff + 1; iBody < this->bodies->getN();
           iBody++) {
